            ...
            <div className="flex flex-wrap -mx-4">
              <div className="mb-8 lg:mb-0 w-full md:w-1/2 lg:w-1/3 px-4">
                <div className="py-10 px-6 bg-white shadow rounded text-center">
                  ...
                  <p className="text-gray-500 leading-loose">
                    Describe who you are, what are your skills, and what would
                    you like to build.{" "}
                  </p>
                </div>
              </div>
              <div className="mb-8 lg:mb-0 w-full md:w-1/2 lg:w-1/3 px-4">
                <div className="py-10 px-6 bg-white shadow rounded text-center">
                  ...
                  <p className="text-gray-500 leading-loose">
                    Setup filters and start looking through other profiles.
                    Interested in talking to someone? Like their profile.
                  </p>
                </div>
              </div>
              <div className="w-full md:w-full lg:w-1/3 px-4">
                <div className="py-10 px-6 bg-white shadow rounded text-center">
                  ...
                  <p className="text-gray-500 leading-loose">
                    If somebody liked back your profile you have a match! Now
                    you may instantly jump into conversion and start building!
                  </p>
                </div>
              </div>
            </div>
